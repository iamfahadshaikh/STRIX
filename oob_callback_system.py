...
class OOBCallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if callback_id in self.callback_registry:
            ...
            logger.info(f"OOB Callback triggered: {callback_id} from {self.client_address[0]}")
...
class OOBCallbackSystem:
    ...
    def create_dns_callback(self, endpoint: str, parameter: str, 
                           domain: str = "callback.attacker.com") -> CallbackPayload:
        """
    ...
    def wait_for_callback(self, callback: CallbackPayload, 
    ...
    def correlate_callback_to_payload(self, callback_id: str, 
    ...
    def generate_ssrf_payloads_with_callbacks(self, endpoint: str, 
