...
class EnhancedConfidenceEngine:
    ...
    def calculate_confidence(
        ...
        # 1. Tool Confidence (0-40 points)
        tool_rating = self.TOOL_CONFIDENCE.get(
            tool_name, self.TOOL_CONFIDENCE["default"]
        )
        ...
        if (
            finding_type in ["xss", "sql_injection", "command_injection"]
            and not crawler_verified
        ):
            penalty += 10
