...
class FindingParser:
    ...
    def _build_finding(
        ...
        evidence_str = (
            ...
            else json.dumps(evidence or {}, ensure_ascii=True)
        )
        ...
        try:
            if isinstance(severity, str):
                ...
                sev_value = (
                    Severity[sev_key]
                    if hasattr(Severity, "__members__")
                    and sev_key in Severity.__members__
                    else Severity.INFO
                )
            else:
                sev_value = severity
...
class FindingPipeline:
    ...
    def ingest_exploitation_results(
